...
public:
  ...
  virtual void writeFile(double currentTime,std::string OutputName, Array2D& solution) = 0;

protected:

  std::shared_ptr<Grid> grid_;  //< a shared pointer to the discretization which contains all data that will be written to the file
