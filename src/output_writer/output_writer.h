...
public:
  ...
  OutputWriter(std::shared_ptr<Variable> variable);
...
protected:
  ...
  std::shared_ptr<Variable> variable_;  //< a shared pointer to the discretization which contains all data that will be written to the file
