...
public:
    ...
    double IntGaussLegendreQuadDeriv(std::function<double(double, double)> func, int j, double a, double b, double ay, double by);
    double IntGaussLegendreQuad(std::function<double(double, double)> func, int j, double a, double b, double ay, double by, double m);
    double IntSurfaceLegendreGauss(std::function<double(double, double)> func, int deg, double a, double b, double ay, double by, double m);
    double IntSurfaceLegendreGaussX(std::function<double(double, double)> func, int deg, double a, double b, double ay, double by, double m);
    double IntSurfaceLegendreGaussY(std::function<double(double, double)> func, int deg, double a, double b, double ay, double by, double m);
