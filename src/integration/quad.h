...
public:
    ...
    double IntJ_0(std::function<double(double)> func, int j, double a, double b, double m);
    ...
    double IntFluxGaussLegendreQuad(std::function<double(double)> func,int i,int j ,double a, double b,const Array2D& u,const Array2D& source);
    double IntFluxGaussLegendreQuad(std::function<double(double)> func, int i, int j, double a, double b, const Array2D &u, double m);
    ...
    double IntFluxU(std::function<double(double)> transportFunc, std::function<double(double, double)> func, int i, int j, double a, double b, const Array2D &u, const Array2D &q, const Array2D &source, bool isSource, bool isTransport);
    double IntFluxU(int i, int j, double a, double b, const Array2D &u, const Array2D &source, double m);
};
